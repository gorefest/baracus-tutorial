...
public class HelloAndroidActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(net.mantucon.baracustutorial.R.layout.activity_main);
        ...
        expandableListView = (ExpandableListView) findViewById(net.mantucon.baracustutorial.R.id.expandableListView);
